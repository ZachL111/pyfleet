"""Regression checks for the pyfleet casebook."""
...
from casebook.harness import assert_expected, pyfleet_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(pyfleet_summary(), assert_expected())
