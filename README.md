...
pyfleet is a Python project for distributed systems. It focuses on this technical goal: Schedule workloads onto heterogeneous nodes with bin-packing and drain plans.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 176, risk penalty 7, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
